 ...
 */
  private void mainMenu() {
    ...
    System.out.println("4. Pending Order Details");
 ...
 */
  private void createOrder() {
    ...
    try {
      ...
      if (balance > totalPrice) {
        ...
        int orderId =  OrderFactory.placeOrder(newOrder);
  ...
  private void showOrderDetails() {
    ...
    try {
      ...
      System.out.println("------------------------------------------------------------------------------------------------");
      System.out.printf("%10s %10s %10s %15s %15s", "Order_Id", "Cust_Id", "Ven_id", "Order_Price", "Order_Date");
      System.out.println();
      System.out.println("-------------------------------------------------------------------------------------------------");
      for (Orders o : orders) {
        System.out.printf("%10d %10d %10d %15.2f %15s", o.getOrderId(), o.getCusId(), o.getVenId(), o.getOrderPrice(), o.getOrderDate());
        System.out.println();
      }
      System.out.println();
      System.out.println();
  ...
  private void showPendingOrder() {
    ...
    try {
      ...
      System.out.println("------------------------------------------------------------------------------------------------");
      System.out.printf("%10s %10s %10s %15s %15s", "Order_Id", "Cust_Id", "Ven_id", "Order_Price", "Order_status");
      System.out.println();
      System.out.println("-------------------------------------------------------------------------------------------------");
      for (Orders o : orders) {
        System.out.printf("%10d %10d %10d %15.2f %15s", o.getOrderId(), o.getCusId(), o.getVenId(), o.getOrderPrice(), o.getOrderStatus());
        System.out.println();
      }
      System.out.println();
      System.out.println();
 ...
 */
  private void showOrderStatus() {
    ...
    try {
      ...
      System.out.println("----------------------------------------------------");
      System.out.printf("%10s %10s %15s", "Vendor Id", "Order Id", "Order Status");
      System.out.println();
      System.out.println("----------------------------------------------------");
      for (Orders orderDetails : order) {
        System.out.printf("%10d %10d %15s", orderDetails.getVenId(), orderDetails.getOrderId(), orderDetails.getOrderStatus());
        System.out.println();
      }
      System.out.println();
      System.out.println();
 ...
 */
  private void showCustomerDetails() {
    List<Customer> customer = CustomerFactory.showCustomer();
    System.out.println("---------------------------------------------------------");
    System.out.printf("%10s %20s %20s", "Customer_Id", "Customer_name", "Customer_mobile");
    System.out.println();
    System.out.println("---------------------------------------------------------");
    for (Customer c : customer) {
      System.out.format("%10d %20s %20s", c.getCusId(), c.getCusName(), c.getCusMob());
      System.out.println();
    }
    System.out.println();
    System.out.println();
