...
public interface WalletDAO {
  ...
  /**
   *
   * @param cusId to initialize WalId.
   * @return walId
   */
  /*@SqlQuery("select * from Wallet where wal_cusId=:cusId and wal_bal > total")
  double showEnoughWallet(@Bind("cusId")int cusId, @Bind("total")int total);
  }*/
