 ...
 */
   ...
   */
  public Orders(final double argOrderPrice, final int argwalId, final int argCusId, final int argVenId,
  ...
  @Override
    ...
    return Objects.hash(orderId, orderStatus, orderPrice, orderDate, walId, cusId, venId, comments, cusName, venName, walName, qty);
  }
    /**
