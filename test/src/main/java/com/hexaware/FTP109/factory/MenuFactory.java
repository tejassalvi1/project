...
public class MenuFactory {
  ...
  * @return the array of food object.

  public static List<MenuDetails> getAllFood() {
    List<MenuDetails> foodDetails = dao().getAllFood();
    return foodDetails;
  }   */
  /**
  * Call the data base connection.
  ...
  /**
  *@param foodId initialize food name.
  * @return the array of food object.
   */
  public static List<MenuDetails> findVendorByFoodName(final int foodId) {
    List<MenuDetails> foodDetails = dao().findVendorByFoodName(foodId);
    return foodDetails;
  }
}
